<html>
<head>
	<title>Electronics | Tech Books</title>
...
<div class="navbar-default" id="navbar">
 ...
 <div class="container">
	...
	<div class="box">
      <center>
	  <h3>Second Year</h3>
          <a href="../database.jsp?p=<%="ece"%>&id=<%=2 %>" class="btn btn-primary">Click</a>
	  </center>
	</div>
	</div>
	...
	<div class="box">
	  <center>
	  <h3>Third Year</h3>
          <a href="../database.jsp?p=<%="ece"%>&id=<%=3 %>" class="btn btn-primary">Click</a>
	</center>
	</div>
	</div>
	...
	<center>
	  <h3>Fourth Year</h3>
          <a href="../fourthyear.jsp?p=<%="ece"%>&id=<%=4 %>" class="btn btn-primary">Click</a>
	  </center>
	</div>
	</div>
	</form>
