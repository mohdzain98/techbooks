    ...
    <div class='col-md-12 col-xs-12'>
        ...
        <div class="box" >
           <sql:query dataSource="${db}" var="em">  
                ...
                <input type="button" name="em" class="visible-xs btn btn-primary" data-toggle="collapse" data-target="#one" value="View" 
        ...
        <div class="box" >
           <sql:query dataSource="${db}" var="em">  
                ...
                <input type="button" name="em" class="visible-xs btn btn-primary" data-toggle="collapse" data-target="#two" value="View"
                       style="margin-left: 10px;">
        </div>
        <jsp:include page="includes/ysubject.jsp">
        ...
        <div class="box" >
           <sql:query dataSource="${db}" var="em">  
                ...
                <input type="button" name="em" class="visible-xs btn btn-primary" data-toggle="collapse" data-target="#three" value="View"
                       style="margin-left: 10px;">
        </div>
        ...
        <div class="box col-md-12">
			...
			<sql:query dataSource="${db}" var="em">  
                ...
                <input type="button" name="em" class="visible-xs btn btn-primary" data-toggle="collapse" data-target="#four" value="View">
        </div>
        ...
        <div class="box col-md-12">
			...
			<sql:query dataSource="${db}" var="em">  
                ...
                <input type="button" name="em" class="visible-xs btn btn-primary" data-toggle="collapse" data-target="#five" value="View">
        </div>
             <jsp:include page="includes/elective.jsp">
        ...
        <div class="box col-md-12">
			...
			<sql:query dataSource="${db}" var="em">  
                ...
                <input type="button" name="em" class="visible-xs btn btn-primary" data-toggle="collapse" data-target="#six" value="View">
        </div>
        ...
        <div class="box col-md-12">
			...
			<sql:query dataSource="${db}" var="em">  
                ...
                <input type="button" name="em" class="visible-xs btn btn-primary" data-toggle="collapse" data-target="#seven" value="View">
        </div>
            <jsp:include page="includes/elective.jsp">
        ...
        <div class="box col-md-12">
                <label class="col-md-3">Elective V :</label>
                <div class="col-md-6">
                <form method="POST" action="">
                <select name="e5" class="form-control">
			<option>select the subject</option>						
			<sql:query dataSource="${db}" var="em">  
                    SELECT * from foyear where extra='<%=db %>' and id='e5';  
                    </sql:query>                  
                   <c:forEach var="table" items="${em.rows}"> <option> <c:out value="${table.sub_name}"/> </option> </c:forEach>
                    </select>
                    <input type="submit" value="enter" class="btn btn-sm" style="margin-top: 5px;">
                ...
                <input type="button" name="em" class="visible-xs btn btn-primary" data-toggle="collapse" data-target="#eight" value="View">
        </div>
                
            <jsp:include page="includes/elective.jsp">
                <jsp:param name="target" value="eight"></jsp:param>
                <jsp:param name="id" value="8"></jsp:param>
                <jsp:param name="elective" value="<%=e5 %>"></jsp:param>
                <jsp:param name="table" value="<%=db %>"></jsp:param>
                <jsp:param name="year" value="<%=id %>"></jsp:param>
            </jsp:include>
        
        <div class="box col-md-12">
                <label class="col-md-3">Elective VI :</label>
                <div class="col-md-6">
                <form method="POST" action="">
                <select name="e6" class="form-control">
			<option>select the subject</option>						
			<sql:query dataSource="${db}" var="em">  
                    SELECT * from foyear where extra='<%=db %>' and id='e6';  
                    </sql:query>                  
                   <c:forEach var="table" items="${em.rows}"> <option> <c:out value="${table.sub_name}"/> </option> </c:forEach>
                    </select>
                    <input type="submit" value="enter" class="btn btn-sm" style="margin-top: 5px;">
                ...
                <input type="button" name="em" class="visible-xs btn btn-primary" data-toggle="collapse" data-target="#nine" value="View">
        </div>
            <jsp:include page="includes/elective.jsp">
                <jsp:param name="target" value="9"></jsp:param>
                <jsp:param name="id" value="9"></jsp:param>
                <jsp:param name="elective" value="<%=e6 %>"></jsp:param>
                <jsp:param name="table" value="<%=db %>"></jsp:param>
                <jsp:param name="year" value="<%=id %>"></jsp:param>
            </jsp:include>
    </div>
