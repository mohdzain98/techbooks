...
<sql:setDataSource var="db" driver="com.mysql.jdbc.Driver"  
     ...
     user="root"  password="Geek@Zain98"/> 
    ...
    <div class='col-md-12'>
        ...
        <div class="box" >
             <sql:query dataSource="${db}" var="em">  
                    ...
                    <h4><c:forEach var="table" items="${em.rows}"> <c:out value="${table.sub_name}" /></c:forEach>
                     <input type="button" name="em" class="btn btn-info" data-toggle="collapse" data-target="#five" value="View" />
                 </h4>
        </div>
            <jsp:include page="includes/ysubject.jsp">
        ...
        <div class="box" >
             <sql:query dataSource="${db}" var="em">  
                    ...
                    <h4><c:forEach var="table" items="${em.rows}"> <c:out value="${table.sub_name}" /></c:forEach>
                     <input type="button" name="em" class="btn btn-info" data-toggle="collapse" data-target="#six" value="View" />
                 </h4>
        </div>
            <jsp:include page="includes/ysubject.jsp">
        ...
        <div class="box" >
             <sql:query dataSource="${db}" var="em">  
                    ...
                    <h4><c:forEach var="table" items="${em.rows}"> <c:out value="${table.sub_name}" /></c:forEach>
                     <input type="button" name="em" class="btn btn-info" data-toggle="collapse" data-target="#seven" value="View" />
                 </h4>
        </div>
            <jsp:include page="includes/ysubject.jsp">
        ...
        <div class="box" >
             <sql:query dataSource="${db}" var="em">  
                    ...
                    <h4><c:forEach var="table" items="${em.rows}"> <c:out value="${table.sub_name}" /></c:forEach>
                     <input type="button" name="em" class="btn btn-info" data-toggle="collapse" data-target="#eight" value="View" />
                 </h4>
        </div>
            <jsp:include page="includes/ysubject.jsp">
        ...
        <div class="box" >
             <sql:query dataSource="${db}" var="em">  
                   SELECT * from subject where extra='<%=db %>' and year_id=<%=id %> and s_no=9; 
                    ...
                    <h4><c:forEach var="table" items="${em.rows}"> <c:out value="${table.sub_name}" /></c:forEach>
                     <input type="button" name="em" class="btn btn-info" data-toggle="collapse" data-target="#nine" value="View" />
                 </h4>
        </div>
            <jsp:include page="includes/ysubject.jsp">
        ...
        <div class="box" >
             <sql:query dataSource="${db}" var="em">  
                    ...
                    <h4><c:forEach var="table" items="${em.rows}"> <c:out value="${table.sub_name}" /></c:forEach>
                     <input type="button" name="em" class="btn btn-info" data-toggle="collapse" data-target="#ten" value="View" />
                 </h4>
        </div>
            <jsp:include page="includes/ysubject.jsp">
        ...
        <div class="box" >
             <sql:query dataSource="${db}" var="em">  
                    ...
                    <h4><c:forEach var="table" items="${em.rows}"> <c:out value="${table.sub_name}" /></c:forEach>
                     <input type="button" name="em" class="btn btn-info" data-toggle="collapse" data-target="#eleven" value="View" />
                 </h4>
        </div>
            <jsp:include page="includes/ysubject.jsp">
        ...
        <div class="box" >
             <sql:query dataSource="${db}" var="em">  
                    ...
                    <h4><c:forEach var="table" items="${em.rows}"> <c:out value="${table.sub_name}" /></c:forEach>
                     <input type="button" name="em" class="btn btn-info" data-toggle="collapse" data-target="#twelve" value="View" />
                 </h4>
        </div>
            <jsp:include page="includes/ysubject.jsp">
