...
<div class="container">
	...
	<div class="box">
      <center>
	  <h3>Second Year</h3>
          <a href="../database.jsp?p=<%="civil"%>&id=<%=2 %>" class="btn btn-primary">Click</a>
	  </center>
	</div>
	</div>
	...
	<div class="box">
	  <center>
	  <h3>Third Year</h3>
          <a href="../database.jsp?p=<%="civil"%>&id=<%=3 %>" class="btn btn-primary">Click</a>
	</center>
	</div>
	</div>
	...
	<center>
	  <h3>Fourth Year</h3>
          <a href="../civil4year.jsp?p=<%="civil"%>&id=<%=4 %>" class="btn btn-primary">Click</a>
	  </center>
	</div>
	</div>
	</form>
